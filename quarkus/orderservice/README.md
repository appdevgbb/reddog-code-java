...
You can then execute your native executable with: `./build/orderservice-1.0-SNAPSHOT-runner`
...
- RESTEasy Reactive ([guide](https://quarkus.io/guides/resteasy-reactive)): A JAX-RS implementation utilizing build time
  ...
  that depend on it.
- OpenTelemetry exporter: Jaeger ([guide](https://quarkus.io/guides/opentelemetry)): Enable Jaeger Exporter for
  OpenTelemetry
